...
int main(int argc, char **argv)
{
  ...
  *  A funcao ros :: init () precisa ver argc e argv para que ele possa executar
  ...
  ros::NodeHandle n; 
    ...
    /**
     * A funcao advertise() eh como voce diz ao ROS o que voce quer publicar em um dado topico.
  ...
  geometry_msgs::Twist mensagem; //objeto para a mesagem
  
  while (ros::ok())
  {
    /**
     * A geometry_msg/Twist expressa a velocidade no espaco dividido em linear e angular
